...
class ActivityLifecycleCallbacksImpl(
    private var mAutoAdaptStrategy: AutoAdaptStrategy?//屏幕适配逻辑策略类
) : Application.ActivityLifecycleCallbacks {
    /**
     * 让 [@Fragment] 支持自定义适配参数
     */
    private val mFragmentLifecycleCallbacks: FragmentLifecycleCallbacksImpl =
        FragmentLifecycleCallbacksImpl(mAutoAdaptStrategy)
