...
public final class AutoSizeCompat {
    ...
    /**
     * 使用 {@link Activity} 或 {@link @Fragment} 的自定义参数进行适配
     *
     * @param resources   {@link Resources}
     * @param customAdapt {@link Activity} 或 {@link @Fragment} 需实现 {@link CustomAdapt}
     */
    ...
    /**
     * 使用外部三方库的 {@link Activity} 或 {@link @Fragment} 的自定义适配参数进行适配
     *
     * @param resources         {@link Resources}
     * @param externalAdaptInfo 三方库的 {@link Activity} 或 {@link @sFragment} 提供的适配参数, 需要配合 {@link ExternalAdaptManager#addExternalAdaptInfoOfActivity(Class, ExternalAdaptInfo)}
     */
