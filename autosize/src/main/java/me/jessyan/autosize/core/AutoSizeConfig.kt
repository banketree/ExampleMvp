...
import me.jessyan.autosize.strategy.DefaultAutoAdaptStrategy
import me.jessyan.autosize.strategy.WrapperAutoAdaptStrategy
...
class AutoSizeConfig private constructor() {
     ...
     * @return [.screenHeight]
     */
    fun getScreenHeight(): Int = if (isUseDeviceSize()) screenHeight else screenHeight - statusBarHeight
    ...
    internal fun init(
        ...
        statusBarHeight = ScreenUtils.statusBarHeight
        LogUtils.d("designWidthInDp = $designWidthInDp, designHeightInDp = $designHeightInDp, screenWidth = $screenWidth, screenHeight = $screenHeight")
     ...
     */
    fun restart() {
        Preconditions.checkNotNull(activityLifecycleCallbacks, "Please call the AutoSizeConfig#init() first")
            ...
            try {
                ...
                if (applicationInfo != null && applicationInfo.metaData != null) {
                    ...
                    if (applicationInfo.metaData.containsKey(KEY_DESIGN_HEIGHT_IN_DP)) {
                        designHeightInDp = applicationInfo.metaData.get(KEY_DESIGN_HEIGHT_IN_DP) as Int
                    }
                }
