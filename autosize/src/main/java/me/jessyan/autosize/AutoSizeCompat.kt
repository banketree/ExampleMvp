    ...
    companion object {
        ...
        fun autoConvertDensityOfGlobal(resources: Resources) {
            if (AutoSizeConfig.instance!!.isBaseOnWidth()) {
                autoConvertDensityBaseOnWidth(resources, AutoSizeConfig.instance!!.designHeightInDp as Float)
            } else {
                autoConvertDensityBaseOnHeight(resources, AutoSizeConfig.instance!!.designHeightInDp as Float)
            }
        }
